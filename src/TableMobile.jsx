...
export default function TableMobile({ head, filteredData, search, setSearch, sorting, setSorting, setUsers, isEditModeActive, setIsEditModeActive }) {
                    ...
                    <section className="pt-4 first:pt-0">
                        {items.map((i, key) => (
                            <div className="text-sm text-white flex items-center gap-x-6">
                                ...
                                {Array.isArray(i) ? <span className="text-xs mt-2">{i}</span> : isEditModeActive ?
                                    ...
                                    (typeof i === "string" && i.includes("@") ?
                                        <div className="flex items-center text-xs">
                                            ...
                                            <Clipboard i={i}/>
                                        </div> : <span className="text-xs">{i}</span>)}
                            </div>
                        ))}
                    </section>
                ))}
                ...
                >
                    {({ errors, touched }) => (
                        ...
                        <Form>
                            ...
                            <button type="submit" className="bg-orange-400 p-1 rounded my-auto mt-8 w-16 text-sm">add</button>
